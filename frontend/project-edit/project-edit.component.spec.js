describe('projectEdit', () => {
  ...
  describe('ProjectEditController', () => {
    ...
    const mockForm = {
      ...
      peopleStrings: [],
      campusCheckboxes: [
        { id: 1, name: 'IU Bloomington', checked: true },
        { id: 2, name: 'IU East' },
        { id: 3, name: 'IU Kokomo', checked: true },
      ],
      categoryCheckboxes: [
        { id: 1, name: 'Virtual Reality' },
        { id: 2, name: 'Augmented Reality', checked: true },
        { id: 3, name: '3D Digitization', checked: true },
      ],
      disciplineCheckboxes: [
        { id: 1, name: 'Science and Mathematics', checked: true },
        { id: 2, name: 'Engineering and Technology', checked: true },
        { id: 3, name: 'Informatics and Computing' },
      ],
      imageData: null,
    };
